...
class _Question_PageState extends State<Question_Page>
            ...
            ? Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('backgrounds/question_page.png'),
                        fit: BoxFit.cover)),
                child: SafeArea(
                                            ...
                                            child: CircleAvatar(
                                              ...
                                              backgroundImage:
                                                  _skip_quesion_lifeline != 0
                                                      ? AssetImage(
                                                          "backgrounds/skip.png")
                                                      : AssetImage(
                                                          "backgrounds/no_skip.png"),
                                            ),
                                          ),
                                          Text(
                                            "Skip\nQuestion",
                                          ...
                                          GestureDetector(
                                            ...
                                            child: CircleAvatar(
                                              ...
                                              backgroundImage:
                                                  _freeze_time_lifeline != 0
                                                      ? AssetImage(
                                                          "backgrounds/freeze.png")
                                                      : AssetImage(
                                                          "backgrounds/no_freeze.png"),
                                            ),
                                          ),
                                          Text(
                                            "Freeze\nTime",
                                          ...
                                          GestureDetector(
                                            ...
                                            child: CircleAvatar(
                                              ...
                                              backgroundImage: _addtime_lifeline !=
                                                      0
                                                  ? AssetImage(
                                                      "backgrounds/addtimer.png")
                                                  : AssetImage(
                                                      "backgrounds/no_addtimer.png"),
                                            ),
                                          ),
                                          Text(
                                            "Add\nTime",
  ...
  Future<void> getQuestions() async {
    ...
    final String response =
        await rootBundle.loadString('questions/easy-level-questions.json');
